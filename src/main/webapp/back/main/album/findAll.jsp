        ...
        handler: function () {
           ...
           if(row == null ){
               ...
               if(row.size == null){  //选中的是专辑
                   ...
                   $("#coverImg").prop("src",'${pageContext.request.contextPath}/back/main/album'+row.coverImg);
        ...
        handler: function () {
            ...
            if(row==null){
                ...
                if(row.size == null){
                    ...
                    location.href = "${pageContext.request.contextPath}/chapter/download?fileName=" + row.downPath + "&openStyle="+row.title;
                }
            }
    ...
    $(function () {
        $("#album").treegrid({
            ...
            columns: [[
                ...
                {field:'downPath',title:'下载路径',width:50,align:'left'},
...
<div id="album_dialog" class="easyui-dialog" title="专辑详情" style="width:400px;height:500px;"
    ...
    <form id="album_ff" method="post">
        ...
        <div style="margin-top: 30px;padding-left: 20%;padding-right: 20%">
            ...
            <img id="coverImg" src="'${pageContext.request.contextPath}/back/main/album'+coverImg" style="width:60%;height: 60%">
        </div>
...
0        </div>
        ...
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
            <input name="size"  required="true" class="easyui-textbox" data-options="iconCls:'icon-man',prompt:'章节大小'" style="width:100%;height: 100%">
        </div>
        <div style="height: 40px;margin-top: 30px;padding-left: 20%;padding-right: 20%">
