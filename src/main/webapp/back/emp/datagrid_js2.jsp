    ...
    <script>
        $(function () {
            ...
            $("#dg").datagrid({
                ...
                columns:[[
                    ...
                    {title:'sex',field:'sex',width:120,sortable:true},
        ...
        function delBatchRows(){
            ...
            if(rows.length<=0){
                ...
                $.ajax({
                    url:"${pageContext.request.contextPath}/emp/Pdelete",
                    type:"POST",
...
<%--保存用户对话框--%>
<div id="saveUserDialog" data-options="href:'${pageContext.request.contextPath}/back/emp/save.jsp',draggable:false,iconCls:'icon-save',width:600,height:400,title:'保存用户信息'">
